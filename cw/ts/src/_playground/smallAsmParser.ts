...
export interface factor_2 {
    kind: ASTKinds.factor_2;
    arg: variable;
}
...
export class Parser {
    ...
    protected $scope$variable$memo: Map<number, [Nullable<variable>, PosInfo]> = new Map();
                ...
                return this.run<fn>($$dpth,
                    () => {
                        ...
                        if (true
                            ...
                            && this.match_($$dpth + 1, $$cr) !== null
                            && ($scope$arg = this.loop<argList>(() => this.matchargList($$dpth + 1, $$cr), true)) !== null
                            && this.match_($$dpth + 1, $$cr) !== null
                            && this.regexAccept(String.raw`(?:\])`, $$dpth + 1, $$cr) !== null
                            && this.match_($$dpth + 1, $$cr) !== null
        ...
        return this.memoise(
            () => {
                return this.run<argList>($$dpth,
                    () => {
                        let $scope$name: Nullable<variable>;
                        let $$res: Nullable<argList> = null;
                        if (true
                            && ($scope$name = this.matchvariable($$dpth + 1, $$cr)) !== null
                            && this.match_($$dpth + 1, $$cr) !== null
                        ) {
                            $$res = {kind: ASTKinds.argList, name: $scope$name};
                        }
                        return $$res;
                    });
            },
        ...
        return this.run<expression_1>($$dpth,
            () => {
                ...
                if (true
                    ...
                    $$res = {kind: ASTKinds.expression_1, left: $scope$left, op: $scope$op, right: $scope$right};
                }
                return $$res;
            });
    }
        ...
        return this.run<expression_2>($$dpth,
            () => {
                ...
                if (true
                    ...
                    $$res = {kind: ASTKinds.expression_2, left: $scope$left, op: $scope$op, right: $scope$right};
                }
                return $$res;
            });
    }
        ...
        return this.run<term_1>($$dpth,
            () => {
                ...
                if (true
                    ...
                    $$res = {kind: ASTKinds.term_1, left: $scope$left, op: $scope$op, right: $scope$right};
                }
                return $$res;
            });
    }
        ...
        return this.run<term_2>($$dpth,
            () => {
                ...
                if (true
                    ...
                    $$res = {kind: ASTKinds.term_2, left: $scope$left, op: $scope$op, right: $scope$right};
                }
                return $$res;
            });
    }
    ...
    public matchfactor_1($$dpth: number, $$cr?: ErrorTracker): Nullable<factor_1> {
        return this.run<factor_1>($$dpth,
            () => {
                let $scope$imm: Nullable<num>;
                let $$res: Nullable<factor_1> = null;
                if (true
                    && ($scope$imm = this.matchnum($$dpth + 1, $$cr)) !== null
                ) {
                    $$res = {kind: ASTKinds.factor_1, imm: $scope$imm};
                }
                return $$res;
            });
    }
    public matchfactor_2($$dpth: number, $$cr?: ErrorTracker): Nullable<factor_2> {
        return this.run<factor_2>($$dpth,
            () => {
                let $scope$arg: Nullable<variable>;
                let $$res: Nullable<factor_2> = null;
                if (true
                    && ($scope$arg = this.matchvariable($$dpth + 1, $$cr)) !== null
                ) {
                    $$res = {kind: ASTKinds.factor_2, arg: $scope$arg};
                }
                return $$res;
            });
    }
